...
* [people_living.json](/data/people_living.json), which contains living people only
* [people_saints.json](/data/people_saints.json), which contains only Saints
* [people_popes.json](/data/people_popes.json), which contains only Popes
* [people_bishops.json](/data/people_bishops.json), which contains only Bishops
