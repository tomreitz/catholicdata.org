...
* [places_basilicas.json](/data/places_basilicas.json), which contains Basilicas only
* [places_cathedrals.json](/data/places_cathedrals.json), which contains Cathedrals only
